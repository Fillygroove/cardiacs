let songInfo = { 
	...
	navbox: {
		file: 'stg.jpg',
		caption: 'JIM PUT THE GUN DOWN WHAT THE HE',
		info: [{
			heading: 'Information',
			info: [{
				name: 'Album',
				...
				name: 'Previous',
				info: ['<a href="index.html?s=stg-wormsHero">Dog-Like Sparky</a>']
			}, {
				name: 'Next',
				info: ['<a href="index.html?s=stg-lassie">Insect Hooves On Lassie</a>']
			}]
		}]
	}
};
