...
let songInfo = { 
	...
	lyrics: [
		...
		"Onlook to see if we care if he is heaven sent or",
	...
	navbox: {
		...
		info: [{
			...
			info: [{
				...
				name: 'Previous',
				info: ['<a href="index.html?s=stg-wireless">Wireless</a>']
			}, {
				name: 'Next',
				info: ['<a href="index.html?s=stg-billion">Billion</a>']
			}]
		}]
	}
};
