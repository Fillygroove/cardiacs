let songInfo = { 
	...
	lyrics: [
		'<small><i>Looking for the <a href="index.html?s=sgc-hopeDay">Special Garage Concerts Version</a>?</i></small>',
		"Don't pity me",
		...
		"As easy as ABC",
		"So carve me out an effigy",
		'<small><i>Source: <a href="https://genius.com/Cardiacs-hope-day-lyrics" class="y">Genius</a></i></small>'
	],
	navbox: {
		name: 'Hope Day',
		file: 'seaside.jpg',
		caption: 'SGC Solo is based',
		info: [{
			heading: 'Information',
			info: [{
				name: 'Album',
				...
				name: 'Previous',
				info: ['<a href="index.html?s=seaside-littleManAndAHouse">A Little Man And A House</a>']
			}, {
				name: 'Next',
				info: ['<a href="index.html?s=seaside-dinner">Dinner Time</a>']
			}]
		}]
	}
};
